...
4 changes to the original yaml deployment file will be required.
...
2. **env**: To configure the probe deployment at deployment-time, we need to
...
4. **volumes**: Is just the glue between the 2 volumeMounts
